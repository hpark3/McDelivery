...
<head>
	...
	<meta name="description" content="McDelivery-Korea Mockup Website">
	<meta name="author" content="Hyeran Park">
	<!-- Bootstrap & CSS -->
	...
	<!-- JavaScript & jQuery 연결 -->
	<!-- defer속성 사용: 지연 스크립트는 전체 문서 로드된 후에만 실행 -->
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js" defer></script>
	<script src="<c:url value="/resources/js/bootstrap.min.js" />" defer></script>	
		...
		<div class="container marketing" style="margin-top:150px;">
			<div class="row" align="center" style="margin-bottom: 150px;">
				<div class="col-lg-4" >
					...
					<h2>Quality</h2>
					<p>
						품질은 최고의 재료, 엄격한 조리 방법 그리고 안전이 검증된 준비 방법, 뛰어난 맛을 지닌 제품을 말합니다. 맥도날드의 목표는 고객에게 최적의 가격으로 뛰어난 품질의 제품을 제공하는 것입니다.
				...
				<div class="col-lg-4">
					...
					<h2>Service</h2>
					<p>
						빠르고 친절한 서비스는 맥도날드의 성공에 기반이 되어 왔습니다. 우리의 목표는 고객의 기대를 훨씬 뛰어 넘는 서비스를 제공하는 것입니다. 레스토랑의 크루들이 고객의 입장에서 생각하도록 교육하고, 그에 맞는 책임감과 권한을 부여합니다.
						맥도날드의 서비스는 음식을 제공하는데 그치는 것이 아니라 고객의 행복과 즐거움이 되도록 노력하는 것입니다.
					</p>
				</div>
				<div class="col-lg-4">
					...
					<h2>Value</h2>
					<p>
						맥도날드의 가치는 고품질의 음식, 친절한 직원의 응대, 깨끗한 환경 그리고 빠르고 정확한 서비스 등 고객이 맥도날드에서 접하게 되는 모든 경험을 말합니다.
			...
			<div class="row featurette">
				<div class="col-md-7" style="height:350px;">
					...
					<p class="lead" style="font-size: 18px; margin-top: 40px;">
						...
						메뉴 주문 시 제공 되는 케찹류나 기타 물품의 경우 기본 제공 수량 기준으로 배달하여 드립니다.
					</p>
				</div>
				<div class="col-md-5">
